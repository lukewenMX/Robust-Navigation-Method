...
class LaserScan:
  ...
  def do_range_projection(self):
    ...
    if idx.size:
      ...
      # print(idx_1d, front, end)
      # self.proj_range[:,idx_1d] = np.broadcast_to((self.proj_range[:,end] + self.proj_range[:,front]) / 2, (idx_1d.size, 16)).transpose()
      # self.proj_remission[:,idx_1d] = np.broadcast_to((self.proj_remission[:,end] + self.proj_remission[:,front]) / 2, (idx_1d.size, 16)).transpose()
  ...
  def do_rotation(self, clip_angle = 0, rotation_angle = 0):
    ...
    clip_end = clip_start + 165
    return self.proj_range[:,clip_start : clip_end], self.proj_remission[:, clip_start : clip_end], self.proj_label[:, clip_start : clip_end]
...
if __name__ == "__main__":
  file_name = "./NanyangLink_backup/label/07/pts_l000200.npz"
